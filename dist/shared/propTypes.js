...
exports.isRotate = exports.isRenderMode = exports.isPdf = exports.isPageNumber = exports.isPageIndex = exports.isPage = exports.isLinkService = exports.isFile = exports.isClassName = exports.eventsProps = undefined;
...
var eventsProps = exports.eventsProps = (0, _lodash2.default)(function () {
  ...
  [].concat((0, _toConsumableArray3.default)(_makeEventProps.mouseEvents), (0, _toConsumableArray3.default)(_makeEventProps.touchEvents)).forEach(function (eventName) {
...
var isRenderMode = exports.isRenderMode = _propTypes2.default.oneOf(['canvas', 'svg']);
